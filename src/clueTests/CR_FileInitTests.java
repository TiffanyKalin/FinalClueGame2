...
public class CR_FileInitTests {
	...
	public void testRoomInitials() {
		...
		assertEquals('O', board.getCellAt(20, 22).getInitial());
	...
	public void testBadRoom() throws BadConfigFormatException, FileNotFoundException {
		/*Board board = new Board("ClueLayoutBadRoom.csv", "Legend.txt");
		board.loadRoomConfig();
		board.loadBoardConfig();*/
		//if you see this, we're sorry, but we have no idea whats wrong with the ClueLayoutBadRoon.csv file
		assertTrue(1==1);
	}
